...
export function Footer() {
  const matchClassPage = useMatch("/classes/profile/:id");

  return (
    <footer style={{ display: matchClassPage ? "none" : "block" }}>
      <Box
        sx={{
          bgcolor: "#2D3748",
          py: 4,
      ...
      >
        <Container maxWidth="xl">
          ...
          >
            © {new Date().getFullYear()} Projeto Aprendiz Polo Urucânia. Todos
